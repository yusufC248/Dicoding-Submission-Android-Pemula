package com.pursan.rifzki.academy
...
object AcademyData {
    private var data = arrayOf(
        arrayOf(
            ...
            "3,72 dari 5",
            "@drawable/ikigai.png",
            "Buku ini ditulis oleh dua sahabat asal negara Spanyol, Hector Garcia dan Francesc Miralles. Kini mereka sudah sah menetap di Jepang. Ikigai sudah dicetak sebanyak 500.000 eksemplar, sukses menduduki gelar International Best Seller. \n" +
                    "\n" +"Tidak hanya membahas rahasia hidup bahagia, buku ini juga membahas kiat-kiat hidup sehat dan sejahtera ala orang Jepang. Menariknya, buku ini dilengkapi dengan ilustrasi yang akan memanjakan mata Anda. Buku ini ditujukan untuk semua lapisan masyarakat yang ingin hidup sejahtera..",
            "Renebook\n"+
                    "Passion, self-love, gaya hidup\n" +
                    "232\n" +
        ...
        arrayOf(
            ...
            "Kuasailah Kotlin, bahasa pemrograman modern yang asik. Materi kelas ini disusun oleh Dicoding sebagai Google Developers Authorized Training Partner berkolaborasi dengan pelaku industri seperti Deny Prasetyo (Senior Software and Infrastructure Engineer, Gojek).\n " +
        ...
        arrayOf(
            ...
            "Dicoding Indonesia\n" +
                    ...
                    "iOS\n" +
                    "40 Jam\n"+
                    "https://www.dicoding.com/academies/171\n" +
                    "52 Modul\n"
        ),
        arrayOf(
            "Belajar Fundamental Aplikasi iOS",
            "5.00 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_fundamental_aplikasi_ios_logo_230320222535.jpg",
            ...
            "Dicoding Indonesia\n" +
                    ...
                    "iOS\n" +
                    "70 Jam\n"+
                    "https://www.dicoding.com/academies/202\n" +
                    "104 Modul\n"
        ),
        arrayOf(
            "Memulai Pemrograman Dengan Dart",
            "4.83 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/memulai_pemrograman_dengan_dart_logo_230320223401.jpg",
        ...
        arrayOf(
            ...
            "4.89 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_membuat_aplikasi_android_untuk_pemula_logo_071119140631.png",
        ...
        arrayOf(
            ...
            "4.77 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_membuat_augmented_reality_logo_071119141445.png",
            "Mulai karirmu di bidang Augmented Reality dengan landasan pengetahuan industri. Materi disusun oleh tim expert Dicoding bersama perusahaan pelaku industri seperti Shinta VR\n " +
            ...
            "Dicoding Indonesia\n" +
                    ...
                    "AR/VR/MR\n" +
                    "40 Jam\n" +
                    "https://www.dicoding.com/academies/135\n" +
                    "42 Modul\n"
        ),
        arrayOf(
            "Belajar Membuat Virtual Reality",
            "5.00 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_membuat_virtual_reality_logo_251119111738.png",
            "Mulai karirmu di bidang Virtual Reality dengan landasan pengetahuan industri. Materi disusun oleh tim expert Dicoding bersama perusahaan pelaku industri seperti Shinta VR.\n " +
                    ...
                    "\n" + "Kelas ini disusun oleh Dicoding berkolaborasi dengan Shinta VR. Kurikulum kelas ini disusun untuk memenuhi kebutuhan dalam pengembangan pasar Virtual Reality di Indonesia. Penggunaan VR sudah diterapkan di banyak sektor, seperti otomotif, kesehatan, retail, pariwisata, dan arsitektur.",
            "Dicoding Indonesia\n" +
                    "Pemula\n" +
                    "AR/VR/MR\n" +
                    "40 Jam\n" +
        ...
        arrayOf(
            ...
            "4.91 / 5",
            "https://d17ivq9b7rppb3.cloudfront.net/original/academy/belajar_membuat_game_untuk_pemula_logo_071119140724.png",
            "Mulai karirmu sebagai Unity Game Developer dari sini. Materi disusun oleh Dicoding dan Asosiasi Game Indonesia (AGI).\n " +
    ...
    val listData: ArrayList<Academy>
        get() {
            val list = ArrayList<Academy>()
            for (aData in data) {
                val academy = Academy()
                academy.name = aData[0]
                academy.rate = aData[1]
                academy.photo = aData[2]
                academy.overview = aData[3]
                academy.detail = aData[4]
